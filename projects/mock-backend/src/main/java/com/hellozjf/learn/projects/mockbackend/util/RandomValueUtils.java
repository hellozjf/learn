 ...
 * 参考：https://blog.csdn.net/w690333243/article/details/89600893
 *
 * @author hellozjf
 */
public class RandomValueUtils {
    ...
    public static Person getPerson() {
        ...
        Map map = getAddress();
        person.setName(getChineseName());
        person.setSex(name_sex.equals("男") ? 1 : 2);
        person.setRoad(getRoad());
        person.setTel(getTel());
        person.setEmail(getEmail(6, 9));
        return person;
    }
