...
/**
 * 参考：https://yq.aliyun.com/articles/18443
 *
...
public class CharacterPinYinConvert
{
    ...
    private static CharacterPinYinConvert characterPinYinConvert;

    public static String getPinyin(String text) {
        if (characterPinYinConvert == null) {
            characterPinYinConvert = new CharacterPinYinConvert();
        }
        return characterPinYinConvert.toPinYin(text);
    }
}
