...
public class ExcelUtils {
     ...
     * @return
     */
    public static <T> List<T> readExcel(String fileName, InputStream inputStream, Class<T> clazz) {
...
//                FileInputStream is = new FileInputStream(new File(path));
    ...
    public static <T> List<T> readExcel(String path, Class<T> cls, MultipartFile file){
        try (InputStream inputStream = file.getInputStream()) {
            return readExcel(file.getOriginalFilename(), inputStream, cls);
        } catch (Exception e) {
            log.error("e = {}", e);
    ...
    public static <T> List<T> readExcel(String path, File file, Class<T> cls) {
        try (InputStream inputStream = new FileInputStream(file)) {
            return readExcel(file.getName(), inputStream, cls);
        } catch (Exception e) {
            log.error("e = {}", e);
            return new ArrayList<>();
        }
